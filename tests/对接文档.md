...
sequenceDiagram
    ...
    Investor ->> invest: transfer(goal_asset)
    ...
    %% 3. 担保
    Guarantor ->> guaranty: transfer(goal_asset)
    ...
    %% 5. 收益进入
    YieldPayer ->> yield: transfer(goal_asset)
