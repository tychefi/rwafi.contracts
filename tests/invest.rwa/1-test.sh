...
mpush sing.token transfer '["gahbnbehaskk", "invest.rwa", "400.00000000 SING", "plan:26"]' -p gahbnbehaskk
mpush sing.token transfer '["flonian", "invest.rwa", "400.00000000 SING", "plan:26"]' -p flonian
