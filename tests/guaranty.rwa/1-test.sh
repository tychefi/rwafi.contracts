...
mpush sing.token transfer '["gahbnbehaskk", "guaranty.rwa", "200.00000000 SING", "guaranty:26"]' -p gahbnbehaskk
mpush sing.token transfer '["flonian", "guaranty.rwa", "200.00000000 SING", "guaranty:26"]' -p flonian
