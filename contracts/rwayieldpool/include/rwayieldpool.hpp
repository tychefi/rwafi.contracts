...
class [[eosio::contract("rwayieldpool")]] rwayieldpool : public eosio::contract {
private:
    dbc                 _db;
...
public:
    ...
    rwayieldpool(eosio::name receiver, eosio::name code, datastream<const char*> ds)
