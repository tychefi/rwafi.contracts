 ...
 * scope: self
 */
struct [[eosio::table, eosio::contract("guaranty.rwa")]] guaranty_stats_t {
    uint64_t        plan_id;                        // PK
 ...
 * scope: plan_id
 */
struct [[eosio::table, eosio::contract("guaranty.rwa")]] guarantor_stake_t {
 ...
 * scope: plan_id
 */
struct [[eosio::table, eosio::contract("guaranty.rwa")]] plan_payment_t {
 ...
 * scope: self
 */
struct [[eosio::table, eosio::contract("guaranty.rwa")]] guaranty_conf_t {
    uint64_t        plan_id;                        // PK
