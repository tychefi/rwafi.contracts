...
#define TBL struct [[eosio::table, eosio::contract("rwaverse.io")]]
#define NTBL(name) struct [[eosio::table(name), eosio::contract("rwaverse.io")]]
...
namespace PlanStatus {
    ...
    static constexpr eosio::name SUCCESS     = "success"_n;      // 担保完成（达到最低的要求软顶了）
