...
int64_t investrwa::_goal_unit(const fundplan_t& plan) {
...
void investrwa::_refresh_and_require_status(fundplan_t& plan,
...
void investrwa::refreshstat(const name& submitter,const uint64_t& plan_id){
...
void investrwa::_create_liquidity(fundplan_t& plan) {
