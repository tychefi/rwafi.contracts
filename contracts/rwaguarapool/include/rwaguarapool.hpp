...
/**
 * @contract rwaguarapool
 * @brief RWA 收益担保合约
 */
class [[eosio::contract("rwaguarapool")]] rwaguarapool : public contract {
public:
    using contract::contract;

    rwaguarapool(name receiver, name code, datastream<const char*> ds)
